...
username : root
password : root
# For Launch the spring back end part you have to download Spring tools suite and import the project include in the todoBackEndSpringBoot folder
# For Launch the Angular front end part you have to "cd" in the todoList-front-end-Angular directory, launch the "npm install" command and then to launch the "npm start" command to launch the application
# Finally you have to write in the internet navigator : http://localhost:4200 and then to click in the second tab of the page (named "go to the todo db tab")
# Context
